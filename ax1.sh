...
collect_udp2raw_params() {
    cyan "--- UDP2RAW 配置 ---"
    read -p "Raw模式 (faketcp/udp/icmp) (默认 faketcp): " raw_mode
    raw_mode=${raw_mode:-faketcp}
    
    read -p "加密模式 (aes128cbc/xor/none) (默认 aes128cbc): " cipher_mode
    cipher_mode=${cipher_mode:-aes128cbc}
    
    read -p "认证模式 (hmac_sha1/simple/md5) (默认 hmac_sha1): " auth_mode
