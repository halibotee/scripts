...
start_new_chain_instance() {
    ...
    if [[ "$chain_type" == "hy2" ]]; then
        ...
        # 设置新增参数的默认值
        main_config=${main_config/__IGNORE_CLIENT_BANDWIDTH__/true}
        main_config=${main_config/__MKCP_MTU__/1200}
        main_config=${main_config/__MKCP_TTI__/30}
        main_config=${main_config/__MKCP_UPLINK__/25}
        main_config=${main_config/__MKCP_DOWNLINK__/100}
        main_config=${main_config/__MKCP_CONGESTION__/true}
        main_config=${main_config/__MKCP_READ_BUF__/4}
        main_config=${main_config/__MKCP_WRITE_BUF__/4}
        main_config=${main_config/__MKCP_HEADER__/wechat-video}
    ...
    temp_udp_config="${temp_udp_config/__RAW_MODE__/faketcp}"
    temp_udp_config="${temp_udp_config/__CIPHER_MODE__/aes128cbc}"
    temp_udp_config="${temp_udp_config/__AUTH_MODE__/hmac_sha1}"
