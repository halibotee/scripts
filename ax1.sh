...
# Modified with ACME integration (Standalone + Chain) & UX Improvements
...
view_chain_client_config() {
    ...
    if [[ "$chain_type" == "hy2" ]]; then
        ...
        sub_link="hysteria2://${hy2_password}@${client_udp2raw_host}:${client_udp2raw_port}?sni=${sni}&insecure=${insecure_flag}#hy2_chain_${host_label}_${id}"
    else # vless
        ...
        sub_link="vless://${uuid}@${client_udp2raw_host}:${client_udp2raw_port}?type=kcp&security=none&headerType=${header_type}&seed=${seed}#vless_Chain_${host_label}_${id}"
    fi
