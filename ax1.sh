...
# --- 2. Systemd 模板文件路径 ---
KCPTUN_TEMPLATE_FILE="/etc/system/ax-kcptun@.service"
UDP2RAW_TEMPLATE_FILE="/etc/system/ax-udp2raw@.service"
HY2_TEMPLATE_FILE="/etc/system/ax-hysteria2@.service"
XRAY_TEMPLATE_FILE="/etc/system/ax-xray@.service"
