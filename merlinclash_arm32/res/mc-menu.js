...
function LoadingMCProgress(seconds) {
	...
	if (action == 0) {
		...
		document.getElementById("loading_block3").innerHTML = "Magic Catling 插件打包中 ..."
		$("#loading_block2").html("<li><font color='#ffcc00'>正在打包插件，请等待...</font></li><li><font color='#ffcc00'>打包完成后将自动下载！</font></li>");
	}	
