...
# =============================================================================
# WARP 分流规则
WARP_DOMAIN_SUFFIX_JSON='"openai.com","chatgpt.com","chat.com","oaiusercontent.com","perplexity.ai","google.com","googleapis.com"'
...
find_available_port() {
    ...
    for ((i=0; i<max_attempts; i++)); do
        ...
        if ! ss -tuln 2>/dev/null | grep -qE "(^|[^0-9:])${port}([^0-9]|$)"; then
            echo "$port"; return
        fi
    done
...
" 2>/dev/null; then
    ...
    route_rules=${route_rules//__WARP_DOMAIN_SUFFIX_LIST__/$WARP_DOMAIN_SUFFIX_JSON}
