...
cfg['route']['rules'] = rules
    if '$final_outbound':
        ...
        cfg['route']['rule_set'] = [
            {"type": "local", "tag": "geoip-cn", "format": "binary", "path": "$SINGBOX_INSTALL_DIR/geoip.db"},
            {"type": "local", "tag": "geosite-cn", "format": "binary", "path": "$SINGBOX_INSTALL_DIR/geosite.db"}
        ]
